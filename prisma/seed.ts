...
async function main() {
  ...
  await prisma.businessConfig.upsert({
    ...
    create: {
      ...
      city: "Barranquilla",
      slogan: "Las mejores arepas, perros y patacones de la ciudad.",
      whatsappNumber: "573001234567",
      instagramUrl: "https://instagram.com/passao",
      facebookUrl: "https://facebook.com/passao",
      heroStatArepas: 12,
      heroStatPerros: 5,
      heroStatPatacones: 10,
      heroStatTotal: 30,
      deliveryFee: 5000,
